...
class WSGIApp(ObjectStoreWSGIApp):
    def __init__(self, object_store: model.AbstractObjectStore, file_store: aasx.AbstractSupplementaryFileContainer,
        ...
        self.url_map = werkzeug.routing.Map([
            Submount(base_path, [
                Rule("/serialization",
                     methods=["GET"], endpoint=self.not_implemented),
                Rule("/description", methods=["GET"],
                ...
                Submount("/shells", [
                    Rule("/$reference", methods=["GET"],
                         endpoint=self.get_aas_all_reference),
                    Rule("/<base64url:aas_id>",
                         methods=["GET"], endpoint=self.get_aas),
                    Rule("/<base64url:aas_id>",
                         methods=["PUT"], endpoint=self.put_aas),
                    Rule("/<base64url:aas_id>",
                         methods=["DELETE"], endpoint=self.delete_aas),
                    Submount("/<base64url:aas_id>", [
                        Rule("/$reference",
                             methods=["GET"], endpoint=self.get_aas_reference),
                        Rule(
                            "/asset-information", methods=["GET"], endpoint=self.get_aas_asset_information),
                        Rule(
                            "/asset-information", methods=["PUT"], endpoint=self.put_aas_asset_information),
                        Rule("/asset-information/thumbnail", methods=["GET", "PUT", "DELETE"],
                             endpoint=self.not_implemented),
                        Rule(
                            "/submodel-refs", methods=["GET"], endpoint=self.get_aas_submodel_refs),
                        Rule(
                            "/submodel-refs", methods=["POST"], endpoint=self.post_aas_submodel_refs),
                        ...
                        Submount("/submodels", [
                            ...
                            Rule("/<base64url:submodel_id>",
                                 endpoint=self.aas_submodel_refs_redirect),
                            Rule("/<base64url:submodel_id>/<path:path>",
                                 endpoint=self.aas_submodel_refs_redirect)
                        ])
                    ])
                ]),
                Rule("/submodels", methods=["GET"],
                     endpoint=self.get_submodel_all),
                Rule("/submodels", methods=["POST"],
                     endpoint=self.post_submodel),
                Submount("/submodels", [
                    Rule(
                        "/$metadata", methods=["GET"], endpoint=self.get_submodel_all_metadata),
                    Rule(
                        "/$reference", methods=["GET"], endpoint=self.get_submodel_all_reference),
                    Rule("/$value", methods=["GET"],
                         endpoint=self.not_implemented),
                    Rule("/$path", methods=["GET"],
                         endpoint=self.not_implemented),
                    Rule("/<base64url:submodel_id>",
                         methods=["GET"], endpoint=self.get_submodel),
                    Rule("/<base64url:submodel_id>",
                         methods=["PUT"], endpoint=self.put_submodel),
                    Rule("/<base64url:submodel_id>",
                         methods=["DELETE"], endpoint=self.delete_submodel),
                    Rule("/<base64url:submodel_id>",
                         methods=["PATCH"], endpoint=self.not_implemented),
                    Submount("/<base64url:submodel_id>", [
                        Rule(
                            "/$metadata", methods=["GET"], endpoint=self.get_submodels_metadata),
                        Rule("/$metadata",
                             methods=["PATCH"], endpoint=self.not_implemented),
                        Rule("/$value", methods=["GET"],
                             endpoint=self.not_implemented),
                        Rule("/$value", methods=["PATCH"],
                             endpoint=self.not_implemented),
                        Rule(
                            "/$reference", methods=["GET"], endpoint=self.get_submodels_reference),
                        Rule("/$path", methods=["GET"],
                             endpoint=self.not_implemented),
                        Rule(
                            "/submodel-elements", methods=["GET"], endpoint=self.get_submodel_submodel_elements),
                        Rule("/submodel-elements", methods=["POST"],
                             endpoint=self.post_submodel_submodel_elements_id_short_path),
                        Submount("/submodel-elements", [
                            Rule(
                                "/$metadata", methods=["GET"], endpoint=self.get_submodel_submodel_elements_metadata),
                            Rule("/$reference", methods=["GET"],
                            ...
                            Submount("/<id_short_path:id_shorts>", [
                                ...
                                Submount("/operation-results", [
                                    Rule(
                                        "/<base64url:handleId>", methods=["GET"], endpoint=self.not_implemented),
                                    Rule("/<base64url:handleId>/$value",
                                         methods=["GET"], endpoint=self.not_implemented)
                                ]),
                        ...
                        Rule(
                            "/qualifiers", methods=["GET"], endpoint=self.get_submodel_submodel_element_qualifiers),
                        Rule(
                            "/qualifiers", methods=["POST"], endpoint=self.post_submodel_submodel_element_qualifiers),
                        Submount("/qualifiers", [
                            Rule("/<base64url:qualifier_type>", methods=["GET"],
                                 endpoint=self.get_submodel_submodel_element_qualifiers),
                            Rule("/<base64url:qualifier_type>", methods=["PUT"],
                ...
                Rule("/concept-descriptions",
                     methods=["GET"], endpoint=self.get_concept_description_all),
                Rule("/concept-descriptions",
                     methods=["POST"], endpoint=self.post_concept_description),
                Submount("/concept-descriptions", [
                    Rule("/<base64url:concept_id>",
                         methods=["GET"], endpoint=self.get_concept_description),
                    Rule("/<base64url:concept_id>",
                         methods=["PUT"], endpoint=self.put_concept_description),
                    Rule("/<base64url:concept_id>",
                         methods=["DELETE"], endpoint=self.delete_concept_description),
                ]),
            ])
        ], converters={
    ...
    def _expect_namespace(cls, obj: object, needle: str) -> model.UniqueIdShortNamespace:
        if not isinstance(obj, model.UniqueIdShortNamespace):
            raise BadRequest(
                f"{obj!r} is not a namespace, can't locate {needle}!")
        return obj
    ...
    def _namespace_submodel_element_op(cls, namespace: model.UniqueIdShortNamespace, op: Callable[[str], T], arg: str) \
        ...
        try:
            ...
            raise NotFound(
                f"Submodel element with id_short {arg} not found in {namespace!r}") from e
    ...
    def _qualifiable_qualifier_op(cls, qualifiable: model.Qualifiable, op: Callable[[str], T], arg: str) -> T:
        try:
            ...
            raise NotFound(
                f"Qualifier with type {arg!r} not found in {qualifiable!r}") from e
    ...
    def _get_submodel_reference(cls, aas: model.AssetAdministrationShell, submodel_id: model.NameType) \
        ...
        for ref in aas.submodel:
            if ref.get_identifier() == submodel_id:
                return ref
        raise NotFound(
            f"The AAS {aas!r} doesn't have a submodel reference to {submodel_id!r}!")

    def _get_shells(self, request: Request) -> Tuple[Iterator[model.AssetAdministrationShell], int]:
        aas: Iterator[model.AssetAdministrationShell] = self._get_all_obj_of_type(
    ...
    def _get_submodels(self, request: Request) -> Tuple[Iterator[model.Submodel], int]:
        submodels: Iterator[model.Submodel] = self._get_all_obj_of_type(
            model.Submodel)
        id_short = request.args.get("idShort")
        if id_short is not None:
        ...
        if semantic_id is not None:
            ...
            submodels = filter(lambda sm: sm.semantic_id ==
                               spec_semantic_id, submodels)
    ...
    def _get_submodel_submodel_elements(self, request: Request, url_args: Dict) -> \
        ...
        paginated_submodel_elements, end_index = self._get_slice(
            request, submodel.submodel_element)
    ...
    def _get_submodel_submodel_elements_id_short_path(self, url_args: Dict) -> model.SubmodelElement:
        submodel = self._get_submodel(url_args)
        submodel_element = self._get_nested_submodel_element(
            submodel, url_args["id_shorts"])
    ...
    def post_aas(self, request: Request, url_args: Dict, response_t: Type[APIResponse],
        ...
        aas = HTTPApiDecoder.request_body(
            request, model.AssetAdministrationShell, False)
        try:
            self.object_store.add(aas)
        except KeyError as e:
            raise Conflict(
                f"AssetAdministrationShell with Identifier {aas.id} already exists!") from e
    ...
    def put_aas_asset_information(self, request: Request, url_args: Dict, response_t: Type[APIResponse],
                                  **_kwargs) -> Response:
        aas = self._get_shell(url_args)
        aas.asset_information = HTTPApiDecoder.request_body(
            request, model.AssetInformation, False)
        return response_t()
    ...
    def post_aas_submodel_refs(self, request: Request, url_args: Dict, response_t: Type[APIResponse],
                               **_kwargs) -> Response:
        aas = self._get_shell(url_args)
        sm_ref = HTTPApiDecoder.request_body(
            request, model.ModelReference, False)
    ...
    def delete_aas_submodel_refs_specific(self, request: Request, url_args: Dict, response_t: Type[APIResponse],
                                          **_kwargs) -> Response:
        aas = self._get_shell(url_args)
        aas.submodel.remove(self._get_submodel_reference(
            aas, url_args["submodel_id"]))
        return response_t()
    ...
    def put_aas_submodel_refs_submodel(self, request: Request, url_args: Dict, response_t: Type[APIResponse],
        ...
        new_submodel = HTTPApiDecoder.request_body(
            request, model.Submodel, is_stripped_request(request))
    ...
    def post_submodel(self, request: Request, url_args: Dict, response_t: Type[APIResponse],
                      map_adapter: MapAdapter) -> Response:
        submodel = HTTPApiDecoder.request_body(
            request, model.Submodel, is_stripped_request(request))
        try:
            self.object_store.add(submodel)
        except KeyError as e:
            raise Conflict(
                f"Submodel with Identifier {submodel.id} already exists!") from e
    ...
    def delete_submodel(self, request: Request, url_args: Dict, response_t: Type[APIResponse], **_kwargs) -> Response:
        self.object_store.remove(self._get_obj_ts(
            url_args["submodel_id"], model.Submodel))
        return response_t()
    ...
    def put_submodel(self, request: Request, url_args: Dict, response_t: Type[APIResponse], **_kwargs) -> Response:
        submodel = self._get_submodel(url_args)
        submodel.update_from(HTTPApiDecoder.request_body(
            request, model.Submodel, is_stripped_request(request)))
        return response_t()

    def get_submodel_submodel_elements(self, request: Request, url_args: Dict, response_t: Type[APIResponse],
                                       **_kwargs) -> Response:
        submodel_elements, cursor = self._get_submodel_submodel_elements(
            request, url_args)
    ...
    def get_submodel_submodel_elements_id_short_path(self, request: Request, url_args: Dict,
                                                     ...
                                                     **_kwargs) -> Response:
        submodel_element = self._get_submodel_submodel_elements_id_short_path(
            url_args)
    ...
    def get_submodel_submodel_elements_id_short_path_metadata(self, request: Request, url_args: Dict,
        ...
        if isinstance(submodel_element, model.Capability) or isinstance(submodel_element, model.Operation):
            raise BadRequest(
                f"{submodel_element.id_short} does not allow the content modifier metadata!")
    ...
    def post_submodel_submodel_elements_id_short_path(self, request: Request, url_args: Dict,
        ...
        if not isinstance(parent, model.UniqueIdShortNamespace):
            raise BadRequest(
                f"{parent!r} is not a namespace, can't add child submodel element!")
    ...
    def delete_submodel_submodel_elements_id_short_path(self, request: Request, url_args: Dict,
        ...
        parent: model.UniqueIdShortNamespace = self._expect_namespace(
            sm_or_se.parent, sm_or_se.id_short)
        self._namespace_submodel_element_op(
            parent, parent.remove_referable, sm_or_se.id_short)
        return response_t()
    ...
    def get_submodel_submodel_element_attachment(self, request: Request, url_args: Dict, **_kwargs) -> Response:
        ...
        if not isinstance(submodel_element, (model.Blob, model.File)):
            raise BadRequest(
                f"{submodel_element!r} is not a Blob or File, no file content to download!")
        ...
        if isinstance(submodel_element, model.Blob):
            ...
            if not submodel_element.value.startswith("/"):
                raise BadRequest(
                    f"{submodel_element!r} references an external file: {submodel_element.value}")
            bytes_io = io.BytesIO()
            try:
    ...
    def put_submodel_submodel_element_attachment(self, request: Request, url_args: Dict, response_t: Type[APIResponse],
        ...
        if not isinstance(submodel_element, model.File):
            raise BadRequest(
                f"{submodel_element!r} is not a File, no file content to update!")
        ...
        if filename is None:
            ...
            raise BadRequest(
                f"Given 'fileName' doesn't start with a slash (/): {filename}")
        ...
        submodel_element.value = self.file_store.add_file(
            filename, file_storage.stream, submodel_element.content_type)
        return response_t()
    ...
    def delete_submodel_submodel_element_attachment(self, request: Request, url_args: Dict,
        ...
        if not isinstance(submodel_element, (model.Blob, model.File)):
            raise BadRequest(
                f"{submodel_element!r} is not a Blob or File, no file content to delete!")
    ...
    def post_submodel_submodel_element_qualifiers(self, request: Request, url_args: Dict, response_t: Type[APIResponse],
                                                  map_adapter: MapAdapter) -> Response:
        sm_or_se = self._get_submodel_or_nested_submodel_element(url_args)
        qualifier = HTTPApiDecoder.request_body(
            request, model.Qualifier, is_stripped_request(request))
        if sm_or_se.qualifier.contains_id("type", qualifier.type):
            raise Conflict(
                f"Qualifier with type {qualifier.type} already exists!")
    ...
    def put_submodel_submodel_element_qualifiers(self, request: Request, url_args: Dict, response_t: Type[APIResponse],
                                                 map_adapter: MapAdapter) -> Response:
        sm_or_se = self._get_submodel_or_nested_submodel_element(url_args)
        new_qualifier = HTTPApiDecoder.request_body(
            request, model.Qualifier, is_stripped_request(request))
        qualifier_type = url_args["qualifier_type"]
        qualifier = self._qualifiable_qualifier_op(
            sm_or_se, sm_or_se.get_qualifier_by_type, qualifier_type)
        ...
        if qualifier_type_changed and sm_or_se.qualifier.contains_id("type", new_qualifier.type):
            raise Conflict(
                f"A qualifier of type {new_qualifier.type!r} already exists for {sm_or_se!r}")
    ...
    def delete_submodel_submodel_element_qualifiers(self, request: Request, url_args: Dict,
        ...
        sm_or_se = self._get_submodel_or_nested_submodel_element(url_args)
        qualifier_type = url_args["qualifier_type"]
        self._qualifiable_qualifier_op(
            sm_or_se, sm_or_se.remove_qualifier_by_type, qualifier_type)
        return response_t()

    # --------- CONCEPT DESCRIPTION ROUTES ---------
    def get_concept_description_all(self, request: Request, url_args: Dict, response_t: Type[APIResponse],
                                    **_kwargs) -> Response:
        concept_descriptions: Iterator[model.ConceptDescription] = self._get_all_obj_of_type(
            model.ConceptDescription)
        concept_descriptions, cursor = self._get_slice(
            request, concept_descriptions)
    ...
    def post_concept_description(self, request: Request, url_args: Dict, response_t: Type[APIResponse],
        ...
        try:
            ...
            raise Conflict(
                f"ConceptDescription with Identifier {concept_description.id} already exists!") from e
