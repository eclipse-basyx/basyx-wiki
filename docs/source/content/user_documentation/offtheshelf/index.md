Out of all available components there already exist off-the-shelf components in BaSyx that can be run independent of the SDKs. This section includes information on how to configure and start them.
