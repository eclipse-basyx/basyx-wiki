...
```
*docker-compose.yml including PostgreSQL 18 and BaSyx Go AAS Registry*
...
```bash
./aasregistryservice -config ./config.yaml -databaseSchema ../../basyxschema.sql
```
