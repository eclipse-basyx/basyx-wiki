...
| SINGLE_AAS | Specifies whether the aas-gui should show only one specific AAS or an List of all AAS "<true/>false>" (optional; ENV variable available starting with eclipsebasyx/aas-gui:v2-2412??) |
| SINGLE_AAS_REDIRECT | Specifies a URL to which redirection should occur in the case of SINGLE_AAS = true and missing `aas` URL query parameter (optional; ENV variable available starting with eclipsebasyx/aas-gui:v2-2412??)
